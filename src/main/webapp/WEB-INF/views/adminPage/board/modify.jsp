...
<body>
	...
	<div class=contents>
		...
		<form action="/adminPage/board/modify" method="post">
	...
	$(document).ready(function(){
		...
		$("button").click(function(e){
			...
			if(operation === 'delete') {
				formObj.attr("action", "/adminPage/board/delete"); // 삭제폼 GET 
				formObj.attr("method", "get"); // form 태그에 method를 post로 해놓아서 
												// 전송전에 get방식으로 변경 
			}else if(operation === 'list'){
				formObj.attr("action", "/adminPage/board/qnaList"); // 게시판리스트 GET
