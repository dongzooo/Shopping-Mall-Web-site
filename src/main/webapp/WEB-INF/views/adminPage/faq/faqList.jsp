...
<body>
    ...
    <main>
        ...
        <section class="content-board">
            <div class="title">
                <h2 style="margin-bottom:1rem;">FAQ/QNA </h2>
            </div>
		...
		<table class = "boardTable" >
			...
			<tr class = "tableHeader" style="margin-bottom: 0.5rem;" >
				<td style="margin-left: 0.3rem">No.</td>
				<td style="margin-left: 1.8rem">제목</td>
				<td style="margin-left: 5.6rem">작성일</td>
				<td style="margin-left: 0rem">수정일</td>
				<td style="margin-left: -2rem">카테고리</td>
			</tr>
		...
		<div class = "buttonWrap" style="margin-top:1rem;">
			<%-- 검색바 --%>
